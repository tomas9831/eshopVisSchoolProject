...
namespace DataLibrary
{
    ...
    {
        private String connectionString = $@"Data Source=(LocalDb)\VisSemestralka;Initial Catalog=VisSemestralka;Integrated Security=True";
        ...
        public bool Connect()
        {
            ...
            if (Connection.State != System.Data.ConnectionState.Open)
            {
                ...
                //ret = Connect(ConfigurationManager.ConnectionStrings["ConnectionStringMsSql"].ConnectionString);
                 ret = Connect($@"Data Source=(LocalDb)\VisSemestralka;Initial Catalog=VisSemestralka;Integrated Security=True");
            }
